...
; InitPorts
; Description:  Initializes the I/O ports for the 5x8 sensor matrix.
InitPorts:
...
; InitTimer0
; Description:  Configures Timer 0 to generate a compare match interrupt
;               approximately every 1 millisecond.
; Assumptions:  System clock is 8 MHz.
InitTimer0:
